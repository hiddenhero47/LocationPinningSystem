...
import { ContainerSvg } from "./index.style";
...
export const FileDownloadIconLg = ({ width, height }) => (
  <ContainerSvg
    ...
    viewBox="0 0 90 90"
    fill="none"
    xmlns="http://www.w3.org/2000/ContainerSvg"
  >
    <path
...
export const DownloadContainerSvg = ({ width, height }) => (
  <ContainerSvg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
DownloadContainerSvg.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  color: PropTypes.any,
};
